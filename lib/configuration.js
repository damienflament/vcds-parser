...
export default class Configuration extends EventTarget {
    ...
    /**
     *@returns {IDBRequest<FileSystemDirectoryHandle | null>}
     */
    get openedDirectory() {
        return this.#get("opened-directory");
    }

    /**
     * @param {FileSystemDirectoryHandle | null} directory
     */
    set openedDirectory(directory) {
        this.#set("opened-directory", directory);
    }
